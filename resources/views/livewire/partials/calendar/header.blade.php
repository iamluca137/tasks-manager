<nav class=" bg-[#f8fafd] px-4 py-2.5 dark:bg-gray-800 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="{{ route('calendar') }}" class="hidden md:flex items-center justify-between mr-4">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Tasks
                    Manager</span>
            </a>
            <div class="flex md:ml-20 items-center justify-between gap-3">
        ...
        <div class="flex items-center lg:order-2">
            {{-- View Setting Calendar --}}
            <div class="hidden md:flex items-center gap-3 ">
                <div class="flex items-center gap-px p-1 rounded-md bg-gray-100">
                    <button
                        class="py-2 px-5 rounded-lg bg-gray-100 text-sm font-medium text-gray-900 transition-all duration-300 hover:bg-white">Day</button>
                    <button
                        class="py-2 px-5 rounded-lg bg-white text-sm font-medium text-gray-900 transition-all duration-300 hover:bg-white">Week</button>
                    <button
                        class="py-2 px-5 rounded-lg bg-gray-100 text-sm font-medium text-gray-900 transition-all duration-300 hover:bg-white">Month</button>
                </div>
            </div>
            {{-- Search --}}
            ...
            <button type="button" data-dropdown-toggle="notification-dropdown"
                class="p-2 mx-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
            ...
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                ...
                <div class="grid grid-cols-3 gap-4 p-4">
                    <a href="#"
                        ...
                        <i
                            class="fa-solid fa-calendar-days fa-lg text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"></i>
                        <div class="text-sm text-gray-900 dark:text-white">Calendar</div>
                    </a>
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                        <i
                            class="fa-solid fa-note fa-lg text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"></i>
                        <div class="text-sm text-gray-900 dark:text-white">Notes</div>
                    </a>
                </div>
            </div>
            <button type="button" class="flex justify-center items-center mx-3 text-sm rounded-full md:mr-0 focus:ring-0" id="user-menu-button"
                aria-expanded="false" data-dropdown-toggle="dropdown">
                <span class="sr-only">Open user menu</span>
                <img class="w-8 h-8 rounded-full" src="{{ Common::getAvatar() }}" alt="user photo" />
            </button>
            <!-- Dropdown menu -->
